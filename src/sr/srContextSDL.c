...
{
    int pixel = SDL_MapRGBA(_sdl.surface->format, SR_HEX_GETR(colour), SR_HEX_GETG(colour),
                            SR_HEX_GETB(colour), SR_HEX_GETA(colour));
...
void _srSDLCtxPutPixel(uint x, uint y, uint32_t colour)
{
    ...
    int pixel = SDL_MapRGBA(surface->format, SR_HEX_GETR(colour), SR_HEX_GETG(colour),
                            SR_HEX_GETB(colour), SR_HEX_GETA(colour));
